...
#define SUBID_RF_ALLBYPASS_STATE_CHGE	SUBID4
#define SUBID_RF_NAME_CHGE				SUBID5
#define SUBID_RF_ACTIVATE_STATE_CHGE	SUBID6
#define SUBID_RF_ONLINE_STATE_CHGE		SUBID7
#define SUBID_RF_LIST_CHGE				SUBID8

//subid ipc
#define SUBID_IPC_BE_DELETED			SUBID3
